...
import { ADD_MOVIE, GET_MOVIES } from "../queries/queries";
    ...
    <>
      <section id="add-page">
        ...
        <div className="container container-width">
          <div className="col-lg">
            <form onSubmit={onSubmit} className="container-width">
              <div className="mb-3">
                <label className="form-label">Title</label>
                <input
                  type="text"
                  className="form-control"
                  placeholder="Movie Title eg: King Kong"
              ...
              <div className="mb-3">
                ...
                <input
                  type="text"
                  className="form-control"
                  placeholder="Movie Poster Path eg: https://amazon.img/chipoleti"
              ...
              <div className="mb-3">
                ...
                <input
                  type="number"
                  className="form-control"
                  placeholder="Movie Popularity Rating eg: 9,2"
              ...
              <div className="mb-3">
                ...
                <input
                  type="text"
                  className="form-control"
                  placeholder="Movie Tags Genre eg: Action,Drama,Crime"
